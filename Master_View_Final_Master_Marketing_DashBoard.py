...
creds = ServiceAccountCredentials.from_json_keyfile_name('/home/ubuntu/da/Master_Marketing_DashBoard/workindia-dashboards-721a8c43109c.json', scope)
client = gspread.authorize(creds)
print("Connected to Google sheets")
sheet = client.open("Marketing_MasterDashBoard_v1")
worksheet = sheet.worksheet('_New_Users_PVT_Raw_Data')

########################################## Read The master Dump File
df2 = pd.read_csv("Output_Final_MMDB.csv")
df = pd.read_csv("/home/ubuntu/da/Master_Marketing_DashBoard/The_Data_Dump_MMDB.csv")
...
df3.to_csv("/home/ubuntu/da/Master_Marketing_DashBoard/The_Data_Dump_MMDB.csv", index = False)
worksheet.clear()
sheet.values_append("'_New_Users_PVT_Raw_Data'!A:E", {'valueInputOption': 'USER_ENTERED'}, {"values": data_with_headers})
sheet.values_append("'_New_Users_PVT_Raw_Data'!K:K", {'valueInputOption': 'USER_ENTERED'}, {"values": [[str(datetime.now())]]})
